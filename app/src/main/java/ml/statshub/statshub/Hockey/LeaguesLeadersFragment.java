...
public class LeaguesLeadersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new BackgroundGetLeaguesLeaders((AppCompatActivity)getActivity(), rView).execute();
        return view;
    }
}

class BackgroundGetLeaguesLeaders extends AsyncTask<Void,Void,String> {

    BackgroundGetLeaguesLeaders(AppCompatActivity c, RecyclerView vue){
        _c = c;
        leaguesLists = vue;
    }
